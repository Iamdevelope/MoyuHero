...
<#if !defineOnly>	 
	...
	<#if genxml =="client" > 
	static void toBIN(String outdir, java.util.Map<Integer,${classname}> ret) throws java.io.IOException {
		java.io.DataOutputStream dataops = null;
		java.io.FileOutputStream fileops = null;
		try {
			fileops = new java.io.FileOutputStream(outdir+"2/"+${classname}.class.getCanonicalName().toLowerCase()+".bin");
			dataops =new java.io.DataOutputStream(fileops);
			for(${classname} obj:ret.values()){
					mytools.SX.toBIN(obj, dataops);
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally{
	...
	public static java.util.Map<Integer,? extends Object> toXML(String confdir,String outdir,XStream xstream) throws java.io.IOException{
		...
		final java.io.FileOutputStream ops=new java.io.FileOutputStream(outdir+"/"+${classname}.class.getCanonicalName().toLowerCase()+".xml");
