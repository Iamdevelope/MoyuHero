...
sinclude(`conf.m4')
	...
	<xbean name="Properties">
		...
		<variable name="jinengdian" type="int"/>			技能点
		<variable name="jinengdiantime" type="long"/>		技能点更新时间
	...
	<xbean name="Troop">
		...
		<variable name="sh1" type="int"/> 神魂1号，0没装
		<variable name="sh2" type="int"/> 神魂2号，0没装
		<variable name="sh3" type="int"/> 神魂3号，0没装
		<variable name="sh4" type="int"/> 神魂4号，0没装
	</xbean>
	<xbean name="Troops">
	...
	<!-- 抽奖信息 by yanglk -->
	<xbean name="lotty">
		<variable name="normalrecruitnum" type="int" default="0"/> 普通招募累计次数
		<variable name="normalrecruittime" type="long" default="0"/> 最后普通招募时间
		<variable name="toprecruitnum" type="int" default="0"/> 顶级招募累计次数
		<variable name="toprecruittime" type="long" default="0"/> 最后顶级招募时间
		<variable name="toprecruitheronum" type="int" default="0"/> 顶级招募累计次数，为招十次必得英雄准备
		<variable name="toptentime" type="int" default="0"/> 顶级招募十连抽时间，为（用户第一次10连抽）10连抽首抽英雄（必掉一个A资质英雄）+1个魂石（临时填的改名卡）准备的
	...
	<!-- 英雄信息 by yanglk -->
	<xbean name="Hero">
		<variable name="key" type="int"/> 英雄唯一ID（新系统可能不需要）
		...
		<variable name="herojinjiestar" type="int"/>     进阶星级
		<variable name="herojinjiesmall" type="int"/>     进阶阶级
		<variable name="heropinji" type="int"/>     品质（升品换英雄配表ID）
		<variable name="heroskill" type="string"/>     技能（:分割，根据位置记录技能等级）
		<variable name="heromishu" type="string"/>     秘术（:一级分割，|二级分割，根据位置记录秘术等级和秘术经验）
		<variable name="heropeiyang" type="string"/>     培养（:分割，根据位置记录培养等级）
		<variable name="heroequip" type="string"/>     装备（:一级分割，|二级分割，根据位置记录装备ID和强化等级）
	</xbean>
	...
	<xbean name="NewShop">
		<variable name="itemid" type="int"/>  77表的道具ID
		<variable name="costtype" type="int"/>  消耗资源
		<variable name="price" type="int"/>  价格
		<variable name="num" type="int"/>  数量
		<variable name="isbuy" type="int"/>  0未购买，1为已购买
	</xbean>
	<xbean name="NewShopList">
		<variable name="shopList" type="list" value="NewShop"/>  单个商城列表
		<variable name="lasttime" type="long"/>  正常刷新时间
		<variable name="refreshtime" type="long"/>  手动刷新时间
		<variable name="refreshnum" type="int"/>  手动刷新次数
	</xbean>
	<xbean name="NewShopMap">
		<variable name="shopMap" type="map" key="int" value="NewShopList"/>  整个商城map，key为76表的序列号
	</xbean>
	
	<table name="newshopcolumns" key="long" value="NewShopMap" cacheCapacity="10000" cachehigh="512" cachelow="256" lock="rolelock"/> yanglk
	...
	<xbean name="ItemNumLimit">
		...
		<variable name="time" type="long"/> 	最后更新时间，清除用
	</xbean>
