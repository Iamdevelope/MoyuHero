...
public class ctimetaskconfig implements mytools.ConvMain.Checkable ,Comparable<ctimetaskconfig>{

	public int compareTo(ctimetaskconfig o){
		return this.id-o.id;
	}
	...
	public ctimetaskconfig(){
		super();
	}
	public ctimetaskconfig(ctimetaskconfig arg){
		this.id=arg.id ;
		this.vip=arg.vip ;
		this.name=arg.name ;
		this.time=arg.time ;
