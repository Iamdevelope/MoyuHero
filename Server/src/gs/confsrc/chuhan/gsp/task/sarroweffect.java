...
public class sarroweffect implements mytools.ConvMain.Checkable ,Comparable<sarroweffect>{

	public int compareTo(sarroweffect o){
		return this.id-o.id;
	}
	...
	public sarroweffect(sarroweffect arg){
		this.id=arg.id ;
		this.step=arg.step ;
