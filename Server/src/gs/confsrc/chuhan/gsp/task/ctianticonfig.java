...
public class ctianticonfig implements mytools.ConvMain.Checkable ,Comparable<ctianticonfig>{

	public int compareTo(ctianticonfig o){
		return this.id-o.id;
	}
	...
	public ctianticonfig(){
		super();
	}
	public ctianticonfig(ctianticonfig arg){
		this.id=arg.id ;
