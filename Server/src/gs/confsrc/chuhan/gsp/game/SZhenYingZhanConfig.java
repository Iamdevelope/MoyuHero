...
public class SZhenYingZhanConfig implements mytools.ConvMain.Checkable ,Comparable<SZhenYingZhanConfig>{

	public int compareTo(SZhenYingZhanConfig o){
		return this.id-o.id;
	}
	...
	public SZhenYingZhanConfig(){
		super();
	}
	public SZhenYingZhanConfig(SZhenYingZhanConfig arg){
		this.id=arg.id ;
		...
		this.endtimeDaily=arg.endtimeDaily ;
		this.changci=arg.changci ;
		this.gongxun3=arg.gongxun3 ;
	}
	 ...
	 * 
	 */
	public String endtimeDaily  = null  ;
	
	public String getEndtimeDaily(){
		return this.endtimeDaily;
	}
	
	public void setEndtimeDaily(String v){
		this.endtimeDaily=v;
	}
	 ...
	 * 
	 */
	public int changci  = 0  ;
	
	public int getChangci(){
		return this.changci;
	}
	
	public void setChangci(int v){
		this.changci=v;
	}
	 ...
	 * 
	 */
	public int gongxun3  = 0  ;
	
	public int getGongxun3(){
		return this.gongxun3;
	}
	
	public void setGongxun3(int v){
		this.gongxun3=v;
	}
