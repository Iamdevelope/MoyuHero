...
public class leijixiaohao implements mytools.ConvMain.Checkable ,Comparable<leijixiaohao>{

	public int compareTo(leijixiaohao o){
		return this.id-o.id;
	}
	...
	public leijixiaohao(leijixiaohao arg){
		this.id=arg.id ;
