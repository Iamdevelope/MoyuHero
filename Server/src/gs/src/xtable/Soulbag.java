...
public class Soulbag {
	Soulbag() {
	}

	public static xbean.Bag get(Long key) {
		return _Tables_.getInstance().soulbag.get(key);
	}

	public static xbean.Bag get(Long key, xbean.Bag value) {
		return _Tables_.getInstance().soulbag.get(key, value);
	}

	public static void insert(Long key, xbean.Bag value) {
		_Tables_.getInstance().soulbag.insert(key, value);
	}

	public static void delete(Long key) {
		_Tables_.getInstance().soulbag.delete(key);
	}

	public static boolean add(Long key, xbean.Bag value) {
		return _Tables_.getInstance().soulbag.add(key, value);
	}

	public static boolean remove(Long key) {
		return _Tables_.getInstance().soulbag.remove(key);
	}

	public static xdb.TTableCache<Long, xbean.Bag> getCache() {
		return _Tables_.getInstance().soulbag.getCache();
	}

	public static xdb.TTable<Long, xbean.Bag> getTable() {
		return _Tables_.getInstance().soulbag;
	}
