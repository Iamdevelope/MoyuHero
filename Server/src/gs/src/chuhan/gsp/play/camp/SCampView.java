...
abstract class __SCampView__ extends xio.Protocol { }

/** 该协议是CMainView或CChangeCampView的返回协议
*/
// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SCampView extends __SCampView__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 788636;
	...
	public SCampView(short _mycamp_, byte _isfreetime_, int _cjifen_, int _hjifen_, int _qjifen_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SCampView) {
			SCampView _o_ = (SCampView)_o1_;
	...
	public int compareTo(SCampView _o_) {
