...
abstract class __SMonthCard__ extends xio.Protocol { }
...
public class SMonthCard extends __SMonthCard__ {
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 789041;
	...
	public SMonthCard(int _result_, int _cardid_, java.util.LinkedList<Integer> _innerdropidlist_) {
