...
abstract class __SDuihuanlb__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SDuihuanlb extends __SDuihuanlb__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 789047;
	...
	public SDuihuanlb(int _result_, java.util.LinkedList<Integer> _innerdropidlist_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SDuihuanlb) {
			SDuihuanlb _o_ = (SDuihuanlb)_o1_;
