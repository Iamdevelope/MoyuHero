...
abstract class __SBeginEndless__ extends xio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SBeginEndless extends __SBeginEndless__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 788934;
	...
	public SBeginEndless(int _result_, chuhan.gsp.play.endlessbattle.endlessBattleInfo _battleinfo_, chuhan.gsp.play.endlessbattle.endlessAttr _attrinfo_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SBeginEndless) {
			SBeginEndless _o_ = (SBeginEndless)_o1_;
