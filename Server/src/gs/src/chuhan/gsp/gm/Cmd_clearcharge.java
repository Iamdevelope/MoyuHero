...
import xbean.ChargeActivityRole;
import xdb.TTable.IWalk;

public class Cmd_clearcharge extends GMCommand {
	...
	boolean exec(String[] args) {
		...
		xtable.Chargeactivities.getTable().walk(new IWalk<Long, ChargeActivityRole>() {
			@Override
			public boolean onRecord(Long k, ChargeActivityRole v) {
				roleids.add(k);
				return true;
			}
		});
