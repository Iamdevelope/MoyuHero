...
abstract class __SSweepBattle__ extends xio.Protocol { }
...
public class SSweepBattle extends __SSweepBattle__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 787945;
	...
	public java.util.LinkedList<chuhan.gsp.stage.BattleInfo> battleinfolist; // 扫荡结果列表
	...
	public SSweepBattle() {
		...
		battleinfolist = new java.util.LinkedList<chuhan.gsp.stage.BattleInfo>();
	}

	public SSweepBattle(int _endtype_, int _smid_, int _time_, int _zhangjie_, java.util.HashMap<Integer,chuhan.gsp.stage.mohe> _moheshop_, java.util.HashMap<Integer,chuhan.gsp.stage.smshopdata> _smshop_, java.util.LinkedList<chuhan.gsp.stage.BattleInfo> _battleinfolist_) {
		...
		this.battleinfolist = _battleinfolist_;
	}
	...
	public final boolean _validator_() {
		...
		for (chuhan.gsp.stage.BattleInfo _v_ : battleinfolist)
	...
	public OctetsStream marshal(OctetsStream _os_) {
		...
		_os_.compact_uint32(battleinfolist.size());
		for (chuhan.gsp.stage.BattleInfo _v_ : battleinfolist) {
			_os_.marshal(_v_);
		}
		return _os_;
	...
	public OctetsStream unmarshal(OctetsStream _os_) throws MarshalException {
		...
		for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; --_size_) {
			chuhan.gsp.stage.BattleInfo _v_ = new chuhan.gsp.stage.BattleInfo();
			_v_.unmarshal(_os_);
			battleinfolist.add(_v_);
		}
		if (!_validator_()) {
			throw new VerifyError("validator failed");
		}
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SSweepBattle) {
			SSweepBattle _o_ = (SSweepBattle)_o1_;
			...
			if (!battleinfolist.equals(_o_.battleinfolist)) return false;
			return true;
		}
		return false;
	}
	...
	public String toString() {
		...
		_sb_.append(battleinfolist).append(",");
		_sb_.append(")");
