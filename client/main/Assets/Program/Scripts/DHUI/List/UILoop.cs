...
/// 作者：EdisonLee
/// 
public class UILoop : UIBase
{
    public delegate void ButtonClick(GameObject go);

    public ButtonClick onItemClick;
    ...
    {
        RectTransform item = GameObject.Instantiate(m_Cell) as RectTransform;
        ...
        item.GetComponent<UILoopItem>().onItemClick = this.onItemClick;
