...
//    //public Sprite HaveReceive;//领取图片

//    public TableReader m_RunecostTable;

//    private GameObject ReceiveGo;//已领取物体
...
//        //IsReceiveImage.sprite = HaveReceive; //UIResourceMgr.LoadSprite(common.defaultPath + "UI_Shenqi_04", typeof(Sprite)) as Sprite;
//        //m_ReceivedText.text = GameUtils.getString("sign_content4");
//    }
//    public void SetIconDate(int _key, GameactivityTemplate _GameactivityTemplate, ActivityOverviewData _ActivityOverviewData)
//    {
...
//        {
//            ReceiveGo.gameObject.SetActive(false);
//        }
//        else
//        {
//            if (_ActivityOverviewData.m_cangetnum == 0)
//            {
//                ReceiveGo.gameObject.SetActive(true);
//            }
//            else
//            {
//                ReceiveGo.gameObject.SetActive(false);
