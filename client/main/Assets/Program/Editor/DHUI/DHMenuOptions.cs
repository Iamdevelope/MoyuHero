...
/// </summary>
/// 
namespace DreamHero.UI
{

	public class DHMenuOptions
	{
		...
		//	DHListView listView = obj.AddComponent<DHListView>();

		//	GameObject continer = new GameObject("Continer");
		//	GameObjectUtility.SetParentAndAlign(continer, obj);

		//	continer.AddComponent<Image>();
		//	RectTransform rect = continer.GetComponent<RectTransform>();

		//	scrollRect.content = rect;

		//}

		//[MenuItem("DHUI/DHTableView", false, 2080)]
		//static public void AddTableView(MenuCommand menuCommand)
		//{
		//	GameObject obj = CreateUIElementRoot("TableView", menuCommand, new Vector2(400, 300));
		...
		//	DHTableView listView = obj.AddComponent<DHTableView>();
		...
		//[MenuItem("DHUI/DHGridView", false, 2090)]
		//static public void AddGridView(MenuCommand menuCommand)
		//{
		//	GameObject obj = CreateUIElementRoot("GridView", menuCommand, new Vector2(400, 300));
		...
		//	DHScrollRect scrollRect = obj.AddComponent<DHScrollRect>();

		//	GameObject continer = new GameObject("Continer");
		//	GameObjectUtility.SetParentAndAlign(continer, obj);

		//	DHGridLayout gridLayout = continer.AddComponent<DHGridLayout>();
		//	ContentSizeFitter contentSize = continer.AddComponent<ContentSizeFitter>();
		...
		//	GameObjectUtility.SetParentAndAlign(item, continer);
		//}
		...
		static public GameObject GetOrCreateCanvasGameObject()
		{
			...
			return DHMenuOptions.CreateNewUI();
		}
	}
